#pragma once
#ifndef __CAVALIA_STORAGE_ENGINE_CONCURRENT_EXECUTOR_H__
#define __CAVALIA_STORAGE_ENGINE_CONCURRENT_EXECUTOR_H__
...
#if defined(LOCK) || defined(OCC) || defined(REPAIR) || defined(SILO) || defined(HYBRID) || defined(DBX)
