#pragma once
#ifndef __CAVALIA_STORAGE_ENGINE_PIPELINE_DYNAMIC_SCHEDULER_H__
#define __CAVALIA_STORAGE_ENGINE_PIPELINE_DYNAMIC_SCHEDULER_H__
...
namespace Cavalia{
	namespace StorageEngine{
		class PipelineDynamicScheduler{
		public:
			PipelineDynamicScheduler(){}
			~PipelineDynamicScheduler(){
		...
		private:
			PipelineDynamicScheduler(const PipelineDynamicScheduler &);
			PipelineDynamicScheduler& operator=(const PipelineDynamicScheduler &);
