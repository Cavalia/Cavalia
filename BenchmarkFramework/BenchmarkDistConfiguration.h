#pragma once
#ifndef __CAVALIA_BENCHMARK_FRAMEWORK_BENCHMARK_DIST_CONFIGURATION_H__
#define __CAVALIA_BENCHMARK_FRAMEWORK_BENCHMARK_DIST_CONFIGURATION_H__
...
namespace Cavalia {
	namespace Benchmark {
		...
		class BenchmarkDistConfiguration {
		public:
			BenchmarkDistConfiguration(const size_t &core_count, const size_t &node_count) : core_count_(core_count), node_count_(node_count) {}
			~BenchmarkDistConfiguration() {}
		...
		private:
			BenchmarkDistConfiguration(const BenchmarkDistConfiguration&);
			BenchmarkDistConfiguration& operator=(const BenchmarkDistConfiguration&);
