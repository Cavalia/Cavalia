#pragma once
#ifndef __CAVALIA_TPCC_BENCHMARK_ATOMIC_PROCEDURES_PAYMENT_PROCEDURE_H__
#define __CAVALIA_TPCC_BENCHMARK_ATOMIC_PROCEDURES_PAYMENT_PROCEDURE_H__
	...
	namespace Benchmark{
		namespace Tpcc{
			namespace AtomicProcedures{
				...
				private:
					PaymentProcedure(const PaymentProcedure&);
					PaymentProcedure& operator=(const PaymentProcedure&);
