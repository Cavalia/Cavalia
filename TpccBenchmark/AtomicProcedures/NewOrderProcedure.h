#pragma once
#ifndef __CAVALIA_TPCC_BENCHMARK_ATOMIC_PROCEDURES_NEW_ORDER_PROCEDURE_H__
#define __CAVALIA_TPCC_BENCHMARK_ATOMIC_PROCEDURES_NEW_ORDER_PROCEDURE_H__
	...
	namespace Benchmark{
		namespace Tpcc{
			namespace AtomicProcedures{
				...
				private:
					NewOrderProcedure(const NewOrderProcedure&);
					NewOrderProcedure& operator=(const NewOrderProcedure&);
